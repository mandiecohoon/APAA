...
class DealsViewController: UIViewController, WKNavigationDelegate, WKUIDelegate {
    ...
    override func viewDidLoad() {
        ...
        var url = NSURL(string:"http://www.lambtoncollege.ca/About_Us/Alumni_Association/Alumni_Benefits/Other/")
